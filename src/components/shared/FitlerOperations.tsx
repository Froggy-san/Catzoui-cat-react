      ...
      {options?.map((option) => (
        <Button
          ...
          className={`${
            ...
            "bg-secondary text-secondary-foreground hover:bg-secondary/80 border border-slate-950"
          }  disabled:bg-secondary disabled:text-secondary-foreground disabled:hover:bg-secondary/80 disabled:border disabled:border-slate-950 disabled:font-semibold  sm:py-1 sm:px-2   tracking-wide leading-5 gap-1 font-normal rounded-lg h-7 text-xs sm:text-[14px]  sm:h-9 `}
        >
          {option.label}
          <span
            className={`${
