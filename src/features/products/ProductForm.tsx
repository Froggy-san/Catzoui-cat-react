...
const ProductForm = ({ product, id }: { id?: string; product?: Product }) => {
  ...
  return (
    <div ref={ref} className="px-5 h-fit">
      <div className=" max-w-5xl min-w-[500px] mx-auto  mt-24 ">
        {product ? (
          <h1 className="text-3xl font-semibold my-10 flex items-center gap-2 justify-center tracking-wider">
        ...
        <Form {...form}>
          <form
            ...
            className="space-y-8 py-7  px-9 rounded-3xl border"
          >
            <FormRow>
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription className="text-green-500 font-semibold">
