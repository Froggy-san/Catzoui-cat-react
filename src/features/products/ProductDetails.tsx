  ...
  return (
    <Drawer open={!!productId} onClose={closeDrawer}>
      ...
      <ClickAwayListener onClickAway={closeDrawer}>
        <DrawerContent className="h-[94dvh] rounded-t-3xl  focus:outline-none pb-4  ">
          <CloseButton
            className="absolute hidden md:block right-5 top-5 cursor-pointer z-50"
            onClick={closeDrawer}
          />

          {isLoading && (
            <ProductDetailsLoading className="pt-9 overflow-y-auto px-4 md:px-24 mb-12" />
          )}
          ...
          {product && product.length && (
            <div
              ref={ref}
              className=" flex flex-col  w-full h-full pt-3 overflow-y-auto px-4 md:px-12   2xl:px-20 "
            >
              <div className="flex flex-col xl:flex-row">
                ...
                <div className="flex-1  md:px-3 lg:px-24 xl:pr-0 xl:pl-14 2xl:pl-32">
                  <ProductTitle title={product.at(0)?.name} />

                  <div className="flex text-sm xs:text-base  space-x-3 items-center justify-between font-semibold mt-3">
                    <ProductPrices
                  ...
                  <Accordion type="single" collapsible>
                    <AccordionItem value="item-1">
                      ...
                      <AccordionContent className="flex flex-col font-semibold space-y-3">
              ...
              <div className=" mt-28 md:px-3 lg:px-24 xl:pr-0 xl:pl-14 2xl:pl-32">
                <h1
